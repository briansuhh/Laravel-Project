                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="blogForm" method="POST" action="{{ route('blog.submit') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" style="height: 100px" id="inputTextArea" name="description"></textarea>
                                    </div>
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-select" id="inputCateg" name="category">
                                            ...
                                            @foreach ($categories as $category)
                                                <option selectvalue="{{ $category->id }}">{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="input-group mb-3">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-dark txt-white" form="blogForm">Add Record<i
